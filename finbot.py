...
bot = Bot(token=TOKEN)
dp = Dispatcher(storage=MemoryStorage())  # Добавил хранилище для FSM
...
# Получение расходов для первой категории
...
# Получение расходов для второй категории
